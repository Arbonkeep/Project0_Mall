...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId, Integer shippingId) {
        ...
        //mybatis 批量插入
        orderItemMapper.batchInnsert(orderItemList);
    ...
    private OrderItemVo assembleOrderItemVo(OrderItem orderItem) {
        ...
        orderItemVo.setQuatity(orderItem.getQuantity());
    ...
    private Order assembleOrder(Integer userId, Integer shippingId, BigDecimal payment) {
        ...
        order.setPaymentType(Constant.PaymentTypeEnum.ALIPAY.getCode());
    ...
    public ServerResponse<OrderVo> getOrderDetail(Integer userId, Long orderNo) {
        ...
        return ServerResponse.createByErrorMessage("没有相应订单");
    }
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String qrPath = String.format(path + "/qr-%s.png",//此处需要加"/"
